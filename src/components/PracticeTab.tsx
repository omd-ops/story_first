...
import { groupLessonsByWeek } from './practice-tab/groupLessonsByWeek';
import { WeekCard } from './practice-tab/WeekCard';
import { PracticeTabProps } from './practice-tab/types';
