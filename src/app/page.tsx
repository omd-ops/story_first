              ...
              <div className="flex items-center gap-6">
                ...
                <nav className="hidden md:flex items-center gap-2">
                  ...
                  >
                    ...
                    <BookOpen
                      className={`w-5 h-5 relative z-10 transition-colors ${currentView === 'practice'
                          ? 'text-white'
                          : 'text-black'
                        }`}
                      strokeWidth={currentView === 'practice' ? 2.5 : 2}
                    />
                    <span className={`text-sm font-semibold relative z-10 transition-colors ${currentView === 'practice'
                        ? 'text-white'
                        : 'text-black'
                      }`}>
                      Learn
              ...
              <div className="flex items-center gap-6">
                ...
                <nav className="hidden md:flex items-center gap-2">
                  ...
                  >
                    ...
                    <Home
                      className={`w-5 h-5 relative z-10 transition-colors ${currentView === 'feed'
                          ? 'text-white'
                          : 'text-black'
                        }`}
                      strokeWidth={currentView === 'feed' ? 2.5 : 2}
                    />
                    <span className={`text-sm font-semibold relative z-10 transition-colors ${currentView === 'feed'
                        ? 'text-white'
                        : 'text-black'
                      }`}>
                      Feed
        ...
        <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-t border-[var(--border)] safe-area-bottom z-40">
          <div className="max-w-lg mx-auto px-4 py-2 flex items-center justify-around">
            ...
            >
              ...
              <BookOpen
                className={`w-6 h-6 relative z-10 transition-colors ${currentView === 'practice'
                    ? 'text-white'
                    : 'text-black'
                  }`}
                strokeWidth={currentView === 'practice' ? 2.5 : 2}
              />
              <span className={`text-xs font-semibold relative z-10 transition-colors ${currentView === 'practice'
                  ? 'text-white'
                  : 'text-black'
                }`}>
                Learn
            ...
            >
              ...
              <Home
                className={`w-6 h-6 relative z-10 transition-colors ${currentView === 'feed'
                    ? 'text-white'
                    : 'text-black'
                  }`}
                strokeWidth={currentView === 'feed' ? 2.5 : 2}
              />
              <span className={`text-xs font-semibold relative z-10 transition-colors ${currentView === 'feed'
                  ? 'text-white'
                  : 'text-black'
                }`}>
                Feed
